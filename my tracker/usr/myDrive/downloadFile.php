...
<button type="button" onclick="window.location.href='/PV/usr/myDrive/dashboard.php'" class="btn btn-default">Drive Home</button>
 ...
 <form class="login-form"  action="<?php echo $_SERVER['PHP_SELF']; ?>"  enctype="multipart/form-data" method="post">
     <h3 class="text-center">Download File </h3><br>
...
?>
              ...
              <div class="form-group">  <label>Please select a file you wish to download.</label> <select class="form-control" id="files" name="mFiles" required>
                </select></div>
 <div class="form-group clearfix">  <input type="submit" class="btn btn-primary btn-lg pull-right" name="submit" value="Get Link for Download">
          </div>
<?php
...
$url=trim("http://prajwalvenkatesh.com/PV/usr/myDrive/download.php?download-file=".$fileName.'&path='.$filepath) ;
echo "<a align='center' href=".'"'.$url.'"'.">Click here to download the file ".$fileName."</a>";
} 
?>
</form>
</div>
